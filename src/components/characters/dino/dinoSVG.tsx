export const DinoSVG = () => {
    return (
        ...
        >
            ...
            <g className="dino-dino">
                <g className="dino-l-arm">
                    <path
                        fill="none"
                        stroke="#7f4fb2"
                        strokeLinecap="round"
