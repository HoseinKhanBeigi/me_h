export const ShrimpSVG = () => {
    return (
        ...
        >
            <desc id="filomenaDesc">
                A calm orange shrimp, with a smile on her face, swimming with her little
                legs
            </desc>
            <g className="filomena-filomena">
                <g className="filomena-back-skirt">
                    <path fill="#00979d">
                        <animate
                            dur="3s"
