        ...
        >
            ...
            <g className="zen-zen">
                ...
                <g className="zen-head">
                    ...
                    />
                    <g className="zen-mustache">
                        <path
                            className="zen-r-mustache_1_"
                            fill="#c2e3ed"
                            d="M50.5 45.8s-1 7.8 6.5 7.8h8s1-7.5-6-7.5-8.5-.3-8.5-.3z"
                        />
                        <path
                            className="zen-l-mustache"
                            fill="#c2e3ed"
